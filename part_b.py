...
mycursor.execute("CREATE TABLE DOE_Schools_database (School_Name VARCHAR(255), Latitude VARCHAR(255), Longitude VARCHAR(255), Grade VARCHAR(255), District VARCHAR(255), Borough VARCHAR(255), School_Website VARCHAR(255), Domain_1 VARCHAR(255), Domain_2 VARCHAR(255))")
...
for school, inner in school_dict.items():
    ...
    sql = "INSERT INTO DOE_Schools_database (School_Name, Latitude, Longitude, Grade, District, Borough, School_Website, Domain_1, Domain_2) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
    val = (school, Latitude, Longitude, Grade, District, Borough, School_Website, Domain1, Domain2)
